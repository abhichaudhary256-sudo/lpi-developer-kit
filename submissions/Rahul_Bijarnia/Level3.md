...
Example
Input: What are digital twins in healthcare?

Process:

Agent calls smile_overview for methodology
Calls query_knowledge for domain insights
Calls get_case_studies for real-world validation
Sends combined data to Ollama
Output:
...
The agent first gathers structured data from these tools and then sends it to the LLM. The LLM does not generate answers randomly — it formats and explains the tool-based information.
